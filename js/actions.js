    ...
    if (action === 'honFuse') {
        ...
        showConfirm('🔧 本伏せ（ほんぶせ）', `
            <div class="tutorial-intro-content" style="text-align:left;">
                ...
                <p style="font-weight:600;margin-top:16px;">📊 品質バー</p>
                <p style="font-size:0.8rem;color:#aaa;margin:2px 0 4px 0;">※10月時点での品質確率を表示</p>
                <ul style="font-size:0.85rem;margin:4px 0 8px 16px;">
                    <li>🟢良 → 収穫量UP</li>
                    <li>🟡普通 → 通常収穫</li>
                    <li>🔴雑菌 → 雑菌キノコ発生</li>
                </ul>
                
                <p style="font-weight:600;margin-top:16px;">💦 散水（7〜9月）</p>
                <ul style="font-size:0.85rem;margin:4px 0 8px 16px;">
                    <li>ボタンが出たらタップ！</li>
                    <li>放置すると品質低下</li>
                </ul>
                
                <p style="font-weight:600;margin-top:16px;">🔄 天地返し（7〜9月）</p>
                <ul style="font-size:0.85rem;margin:4px 0 8px 16px;">
                    <li>実行で<strong>良品質+10%</strong></li>
                    <li>最大2回チャンス</li>
                </ul>
                
                <p style="font-weight:600;margin-top:16px;">🐛 害虫駆除</p>
                <ul style="font-size:0.85rem;margin:4px 0 8px 16px;">
                    <li>3日以内に取り除く！</li>
                    <li>放置で品質低下</li>
                </ul>
                
                <p style="font-weight:600;margin-top:16px;">🏕️ 遮光ネット（道具から購入）</p>
                <ul style="font-size:0.85rem;margin:4px 0 0 16px;">
