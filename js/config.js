...
// アプリバージョン（version.jsonと同期する必要あり）
...
const RANKS = [
    ...
    { level: 6, name: '椎茸神', icon: '🌟', exp: 10000 }
];
...
const SHOP_ITEMS = [
    { id: 'drill', name: '椎茸ドリル', icon: '🔩', desc: '近所のおじさんから貰った中古。原木に穴をあけることができる', price: 0 },
    ...
    { id: 'forklift', name: 'フォークリフト', icon: '🚜', desc: 'まとめて浸水が可能に', price: 20000, monthlyPrice: 1000 },
    { id: 'worker', name: '人を雇う', icon: '👷', desc: '1人50本まで作業可。最大3人（月2500円/人）', price: 0, monthlyPrice: 2500, maxCount: 3 },
    { id: 'cooler', name: 'クーラー', icon: '❄️', desc: '夏も栽培可能に。害虫・散水イベント不要（要:栽培ハウス）', price: 100000, monthlyPrice: 2000, requires: 'greenhouse' }
];
